...
public class NavMeshSurfaceModifierTests
{
    ...
    {
        var plane = UnityEngine.GameObject.CreatePrimitive(PrimitiveType.Plane);
    ...
    {
        UnityEngine.GameObject.DestroyImmediate(modifier.gameObject);
    }
    ...
    public void ModifierIgnoreAffectsChild()
    {
        ...
        var childPlane = UnityEngine.GameObject.CreatePrimitive(PrimitiveType.Plane);
        childPlane.transform.SetParent(modifier.transform);

        surface.BuildNavMesh();

        Assert.IsFalse(NavMeshSurfaceTests.HasNavMeshAtOrigin());
        UnityEngine.GameObject.DestroyImmediate(childPlane);
    }
    ...
    public void ModifierIgnoreDoesNotAffectSibling()
    {
        ...
        var siblingPlane = UnityEngine.GameObject.CreatePrimitive(PrimitiveType.Plane);

        surface.BuildNavMesh();

        Assert.IsTrue(NavMeshSurfaceTests.HasNavMeshAtOrigin());
        UnityEngine.GameObject.DestroyImmediate(siblingPlane);
    }
