...
namespace UnityEditor.AI
{
    ...
    class NavMeshLinkEditor : Editor
    {
        ...
        {
            var parent = menuCommand.context as UnityEngine.GameObject;
            UnityEngine.GameObject go = NavMeshComponentsGUIUtility.CreateAndSelectGameObject("NavMesh Link", parent);
